...
with col3:
    ...
    if break_down_150ema == 'No':
        st.write('* __Up Trend:  Above 150 EMA!__ :heavy_check_mark:')

    if lastBreakOutSignal in ['Yes','Yes Buy']:
        st.write('* __Up Trend:  Above 50,20,10 EMA!__ :heavy_check_mark:')
...
breakout_cols = ['ticker','Date','Open','Close','Volume'
                 ...
                 #,'break_out'
                 ,'break_out_signal','break_down','break_down_150ema']
